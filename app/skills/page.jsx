...
const Skills = () => {
  return (
    <div className="relative">
        ...
        <button className={` absolute top-[-4rem] left-12 tracking-wider rounded-2xl shadow-inner text-white p-3 px-4 bg-[#671e67] hover:bg-[#411b41] ${bagelFatOne.className}`}> <Link href="/">Go Back</Link> </button>
        <div className="w-full text-white mt-[8.5rem] mb-10">
            <h1 className={` text-[4.5rem] ms-[11rem] mb-[5rem] tracking-wider ${bagelFatOne.className}`}>My Skills</h1>
            
            <div className={`mt-16 mb-[8rem] flex justify-center text-center`}> 

                <div className=" flex flex-wrap justify-center gap-5 w-[55%] text-center">
